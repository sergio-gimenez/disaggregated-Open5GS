...
Hit:2 http://ppa.launchpad.net/open5gs/latest/ubuntu focal InRelease                 
...
## Download the Open5GS Source Code (v2.4.3)...

+ curl -sLf 'https://github.com/open5gs/open5gs/archive/v2.4.3.tar.gz' | tar zxf -

## Build the Open5GS WebUI...

+ cd ./open5gs-2.4.3/webui && npm ci --no-optional && npm run build

> uglifyjs-webpack-plugin@0.4.6 postinstall /home/ubuntu/open5gs-2.4.3/webui/node_modules/uglifyjs-webpack-plugin
> node lib/post_install.js

added 749 packages in 10.417s

> open5gs@2.4.3 build /home/ubuntu/open5gs-2.4.3/webui
> next build

> Using external babel configuration
> Location: "/home/ubuntu/open5gs-2.4.3/webui/.babelrc"

## Install the Open5GS WebUI...

+ mv ./open5gs-2.4.3/webui /usr/lib/node_modules/open5gs
...
connecting to: mongodb://127.0.0.1:27017/open5gs
Implicit session: session { "id" : UUID("2e89ccec-f18a-404b-893c-c2285d58887b") }
MongoDB server version: 3.6.8
+ rm -f ./account.js
ubuntu@ubuntu:~$ sudo netstat -tlnp | grep 3000
tcp        0      0 0.0.0.0:3000            0.0.0.0:*               LISTEN      55085/node          
ubuntu@ubuntu:~$ 
ubuntu@ubuntu:~$ vim install 
ubuntu@ubuntu:~$ cat install 
#!/bin/bash
...
sed -i '3 s/localhost/0.0.0.0/g' ./${PACKAGE}-${VERSION}/webui/server/index.js
